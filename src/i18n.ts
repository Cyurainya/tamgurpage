...
export type Messages = {
  ...
  worksWithEyebrow: string;
  worksWithTitle: string;
  worksWithDescription: string;
...
export const messages: Record<Locale, Messages> = {
  'zh-CN': {
    ...
    wechatGroup: '微信群',
    signupBonus: '新用户注册送 $5 免费额度',
    enterpriseDiscount: '企业批量订购享专属折扣',
    heroMetrics: ['高可用服务', '大规模 Token 处理', '持续增长的开发者社区', '持续运行监控'],
    developerBenefits: ['无月费', 'Claude Code 支持', 'Codex 支持', 'OpenAI SDK 兼容', '按量付费', '全球访问'],
    worksWithEyebrow: '兼容工具',
    worksWithTitle: '与你现有的开发工具协同工作',
    worksWithDescription: '无需改变工作流，只需配置 API 地址与密钥即可开始使用。',
    worksWithTools: ['Claude Code', 'Codex', 'Cursor', 'Cline', 'Roo Code', 'OpenAI SDK', 'Anthropic SDK'],
    footerSupport: '支持',
    ...
    featuresTitle: '为什么开发者选择 Tamgur',
    featuresDescription: '不被月费套餐绑定，保留熟悉的开发工具，只为实际使用量付费。',
    features: [
      { title: '更低成本', description: '相比官方 API 价格按低至 1 折计费，让每一笔模型调用更划算。' },
    ...
    pricingTitle: '主流模型 API 价格，低至 1 折',
    ...
    pricingNote: '示例：Tamgur 输入与输出价格按官方价格的约 10%～15% 展示。',
    ...
    pricingDisclaimer: '以上为说明性估算。Tamgur 输入与输出价格按官方公开 API 单价的约 10%～15% 展示。模型提供商可能随时调整价格，请以链接中的官方页面为准。',
    officialSource: '官方价格来源',
    viewMoreModels: '查看更多模型',
    ...
    faqs: [
      {
        ...
        answer: 'Tamgur 按各模型提供商公开的官方 API 价格计算消耗。不同模型与请求类型的折算比例会有所不同，页面中的输入价格示例按区间展示。',
      },
      {
  ...
  en: {
    ...
    heroTitle: 'Tamgur - Large Model API Gateway Platform',
    heroHighlight: 'Save Up to 90%',
    heroModelLine: 'One-stop access to the world’s leading large models, including GPT, Claude, Gemini, and more.',
    heroDescription: 'Seamlessly compatible with OpenAI, Claude, Gemini, and other API formats, with zero-cost migration and unlimited potential.',
    heroMigration: 'Leave tedious debugging behind and bring AI development back to its purest form.',
    heroPriceTitle: 'Typical Monthly Cost',
    ...
    signupBonus: 'New users get $5 in free credits on sign-up',
    enterpriseDiscount: 'Exclusive discounts for enterprise orders',
    heroMetrics: ['High-availability service', 'Large-scale token processing', 'Growing developer community', 'Continuous monitoring'],
    developerBenefits: ['No monthly fees', 'Claude Code support', 'Codex support', 'OpenAI SDK compatible', 'Pay as you go', 'Global access'],
    worksWithEyebrow: 'Works with',
    worksWithTitle: 'Built for the tools you already use',
    worksWithDescription: 'Keep your workflow. Configure the API endpoint and key to get started.',
    worksWithTools: ['Claude Code', 'Codex', 'Cursor', 'Cline', 'Roo Code', 'OpenAI SDK', 'Anthropic SDK'],
    ...
    saveAbout: 'Save up to 90%',
    savingsPrefix: 'Save up to',
    featuresEyebrow: 'Why developers choose Tamgur',
    featuresTitle: 'Why developers choose Tamgur',
    featuresDescription: 'Keep your tools, avoid monthly plans, and pay only for the API usage you need.',
    features: [
      { title: 'Lower Cost', description: 'Save up to 90% compared with official API pricing across supported models.' },
    ...
    pricingTitle: 'Save up to 90% on leading AI model APIs',
    ...
    pricingNote: 'Example: Tamgur input and output pricing is shown at roughly 10%–15% of the published official rate.',
    ...
    pricingDisclaimer: 'Illustrative estimates only. Tamgur input and output prices are shown at roughly 10%–15% of published official API rates. Providers may change pricing at any time; follow the linked official pages for current rates.',
    officialSource: 'Official pricing source',
    viewMoreModels: 'View more models',
  ...
  fr: {
    ...
    heroTitle: 'Tamgur - Plateforme passerelle pour grands modèles',
    heroHighlight: "Jusqu'à -90 %",
    heroModelLine: 'Accès centralisé aux meilleurs grands modèles mondiaux, dont GPT, Claude, Gemini, etc.',
    heroDescription: 'Compatibilité fluide avec les formats API OpenAI, Claude, Gemini et autres, migration sans coût et potentiel illimité.',
    heroMigration: 'Dites adieu aux réglages fastidieux et rendez le développement IA plus simple et direct.',
    heroPriceTitle: 'Coût mensuel typique',
    ...
    signupBonus: "Les nouveaux utilisateurs reçoivent 5 $ de crédits gratuits à l'inscription",
    enterpriseDiscount: 'Remises exclusives pour les entreprises',
    heroMetrics: ['Service haute disponibilité', 'Traitement de Token à grande échelle', 'Communauté de développeurs en croissance', 'Surveillance continue'],
    developerBenefits: ['Aucun frais mensuel', 'Compatible Claude Code', 'Compatible Codex', 'Compatible OpenAI SDK', "Paiement à l'usage", 'Accès mondial'],
    worksWithEyebrow: 'Compatible avec',
    worksWithTitle: 'Fonctionne avec vos outils de développement',
    worksWithDescription: "Conservez votre workflow : configurez l'adresse API et la clé pour commencer.",
    worksWithTools: ['Claude Code', 'Codex', 'Cursor', 'Cline', 'Roo Code', 'OpenAI SDK', 'Anthropic SDK'],
    footerSupport: 'Support',
    footerDocumentation: 'Documentation',
    footerStatus: 'Statut',
    ...
    saveAbout: "Jusqu'à 90 % d'économies",
    savingsPrefix: "Jusqu'à",
    featuresEyebrow: 'Pourquoi choisir Tamgur',
    featuresTitle: 'Pourquoi les développeurs choisissent Tamgur',
    featuresDescription: "Gardez vos outils, évitez les forfaits mensuels et payez uniquement l'utilisation nécessaire.",
    features: [
      { title: 'Coût réduit', description: "Économisez jusqu'à 90 % par rapport aux tarifs API officiels." },
    ...
    pricingTitle: "Économisez jusqu'à 90 % sur les principales API d'IA",
    ...
    pricingNote: "Exemple : les prix d'entrée et de sortie Tamgur sont affichés autour de 10 % à 15 % du tarif API officiel publié.",
    ...
    pricingDisclaimer: "Estimations indicatives. Les prix d'entrée et de sortie Tamgur sont affichés à environ 10 % à 15 % des tarifs API officiels publiés. Les fournisseurs peuvent modifier leurs prix ; consultez les pages officielles liées.",
    officialSource: 'Tarif officiel',
    viewMoreModels: 'Voir plus de modèles',
  ...
  ru: {
    ...
    heroTitle: 'Tamgur - платформа-шлюз для больших моделей',
    heroHighlight: 'Экономия до 90%',
    heroModelLine: 'Единый доступ к ведущим большим моделям мира, включая GPT, Claude, Gemini и другие.',
    heroDescription: 'Бесшовная совместимость с форматами API OpenAI, Claude, Gemini и других сервисов, миграция без затрат и раскрытие полного потенциала.',
    heroMigration: 'Оставьте сложную отладку позади и верните AI-разработке простоту.',
    heroPriceTitle: 'Типичная стоимость в месяц',
    ...
    signupBonus: 'Новые пользователи получают $5 бесплатного кредита при регистрации',
    enterpriseDiscount: 'Специальные скидки для компаний',
    heroMetrics: ['Высокая доступность сервиса', 'Масштабная обработка Token', 'Растущее сообщество разработчиков', 'Непрерывный мониторинг'],
    developerBenefits: ['Без ежемесячной платы', 'Поддержка Claude Code', 'Поддержка Codex', 'Совместимость с OpenAI SDK', 'Оплата по факту', 'Глобальный доступ'],
    worksWithEyebrow: 'Совместимость',
    worksWithTitle: 'Работает с вашими инструментами разработки',
    worksWithDescription: 'Сохраните привычный процесс: укажите адрес API и ключ для начала работы.',
    worksWithTools: ['Claude Code', 'Codex', 'Cursor', 'Cline', 'Roo Code', 'OpenAI SDK', 'Anthropic SDK'],
    ...
    saveAbout: 'Экономия до 90%',
    savingsPrefix: 'Экономия до',
    featuresEyebrow: 'Почему выбирают Tamgur',
    featuresTitle: 'Почему разработчики выбирают Tamgur',
    featuresDescription: 'Используйте привычные инструменты без ежемесячных тарифов и платите только за нужный объём API.',
    features: [
      { title: 'Ниже стоимость', description: 'Экономьте до 90% относительно официальных API-тарифов.' },
    ...
    pricingTitle: 'Экономьте до 90% на API ведущих AI-моделей',
    ...
    pricingNote: 'Пример: цены на ввод и вывод в Tamgur отображаются примерно на уровне 10%–15% от опубликованных официальных API-тарифов.',
    ...
    pricingDisclaimer: 'Это ориентировочные расчёты. Цены на ввод и вывод в Tamgur показаны примерно на уровне 10%–15% от опубликованных официальных API-тарифов. Провайдеры могут менять цены; актуальные данные смотрите по официальным ссылкам.',
    officialSource: 'Официальные цены',
    viewMoreModels: 'Посмотреть больше моделей',
  ...
  ja: {
    ...
    heroTitle: 'Tamgur - 大規模モデル中継プラットフォーム',
    heroHighlight: '最大 90% お得',
    heroModelLine: 'GPT、Claude、Gemini など、世界トップクラスの大規模モデルへワンストップで接続できます。',
    heroDescription: 'OpenAI、Claude、Gemini などの API 形式にシームレス対応し、移行コストなしで無限の可能性を引き出します。',
    heroMigration: '面倒な調整から解放され、AI 開発を本来のシンプルさへ戻します。',
    heroPriceTitle: '一般的な月額コスト',
    ...
    signupBonus: '新規ユーザーは登録で $5 の無料クレジットを獲得',
    enterpriseDiscount: '法人向け特別割引',
    heroMetrics: ['高可用性サービス', '大規模 Token 処理', '成長を続ける開発者コミュニティ', '継続的なモニタリング'],
    developerBenefits: ['月額料金なし', 'Claude Code 対応', 'Codex 対応', 'OpenAI SDK 互換', '従量課金', 'グローバルアクセス'],
    worksWithEyebrow: '対応ツール',
    worksWithTitle: 'いつもの開発ツールでそのまま使える',
    worksWithDescription: 'ワークフローはそのまま。API アドレスとキーを設定するだけで開始できます。',
    worksWithTools: ['Claude Code', 'Codex', 'Cursor', 'Cline', 'Roo Code', 'OpenAI SDK', 'Anthropic SDK'],
    footerSupport: 'サポート',
    ...
    featuresTitle: '開発者が Tamgur を選ぶ理由',
    featuresDescription: '使い慣れたツールを維持し、月額プランなしで必要な API 利用分だけ支払えます。',
    features: [
      { title: '低コスト', description: '公式 API 料金と比べて最大 90% コストを抑えられます。' },
    ...
    pricingTitle: '主要 AI モデル API を最大 90% 節約',
    ...
    pricingNote: '例：Tamgur の入力と出力の料金は、公開されている公式 API 単価のおよそ 10%～15% として表示されます。',
    ...
    pricingDisclaimer: '表示価格は参考値です。Tamgur の入力と出力の料金は、公開されている公式 API 単価のおよそ 10%～15% として表示しています。提供元が価格を変更する場合があるため、最新情報はリンク先の公式ページをご確認ください。',
    officialSource: '公式料金',
    viewMoreModels: 'さらに多くのモデルを見る',
  ...
  vi: {
    ...
    heroTitle: 'Tamgur - Nền tảng trung chuyển mô hình lớn',
    heroHighlight: 'Tiết kiệm đến 90%',
    heroModelLine: 'Truy cập một điểm đến các mô hình lớn hàng đầu thế giới, hỗ trợ GPT, Claude, Gemini và nhiều mô hình khác.',
    heroDescription: 'Kết nối liền mạch với các định dạng API OpenAI, Claude, Gemini và hơn thế nữa, di chuyển không tốn chi phí và mở khóa tiềm năng không giới hạn.',
    heroMigration: 'Tạm biệt việc gỡ lỗi rườm rà, đưa phát triển AI trở lại trạng thái thuần túy.',
    heroPriceTitle: 'Chi phí hàng tháng điển hình',
    ...
    signupBonus: 'Người dùng mới nhận $5 tín dụng miễn phí khi đăng ký',
    enterpriseDiscount: 'Ưu đãi riêng cho doanh nghiệp',
    heroMetrics: ['Dịch vụ có độ sẵn sàng cao', 'Xử lý Token quy mô lớn', 'Cộng đồng nhà phát triển đang phát triển', 'Giám sát liên tục'],
    developerBenefits: ['Không phí hàng tháng', 'Hỗ trợ Claude Code', 'Hỗ trợ Codex', 'Tương thích OpenAI SDK', 'Trả theo mức dùng', 'Truy cập toàn cầu'],
    worksWithEyebrow: 'Tương thích',
    worksWithTitle: 'Hoạt động với các công cụ bạn đang dùng',
    worksWithDescription: 'Giữ nguyên quy trình làm việc, chỉ cần cấu hình địa chỉ API và khóa.',
    worksWithTools: ['Claude Code', 'Codex', 'Cursor', 'Cline', 'Roo Code', 'OpenAI SDK', 'Anthropic SDK'],
    footerSupport: 'Hỗ trợ',
    footerDocumentation: 'Tài liệu',
    footerStatus: 'Trạng thái',
    footerTelegram: 'Telegram',
    ...
    saveAbout: 'Tiết kiệm đến 90%',
    savingsPrefix: 'Tiết kiệm tới',
    featuresEyebrow: 'Vì sao chọn Tamgur',
    featuresTitle: 'Vì sao nhà phát triển chọn Tamgur',
    featuresDescription: 'Giữ nguyên công cụ quen thuộc, không cần gói hàng tháng và chỉ trả cho lượng API thực tế.',
    features: [
      { title: 'Chi phí thấp hơn', description: 'Tiết kiệm đến 90% so với giá API chính thức.' },
    ...
    pricingTitle: 'Tiết kiệm đến 90% cho API mô hình AI hàng đầu',
    ...
    pricingNote: 'Ví dụ: giá đầu vào và đầu ra của Tamgur được hiển thị ở mức khoảng 10%–15% giá API chính thức đã công bố.',
    ...
    pricingDisclaimer: 'Chỉ là ước tính minh họa. Giá đầu vào và đầu ra của Tamgur được hiển thị ở mức khoảng 10%–15% giá API chính thức đã công bố. Nhà cung cấp có thể thay đổi giá; hãy xem các trang chính thức được liên kết để biết mức hiện tại.',
    officialSource: 'Nguồn giá chính thức',
    viewMoreModels: 'Xem thêm mô hình',
...
> = {
  'zh-CN': {
    title: 'Claude Code 与 Codex 按量付费 API | Tamgur',
    description: '摆脱 Claude Max 与 Codex 月度订阅，通过稳定、兼容 OpenAI 的 API 按量使用 Claude Code、Codex、GPT-5 与 Gemini。',
    ogLocale: 'zh_CN',
  },
  en: {
    title: 'Pay-As-You-Go Claude Code & Codex API | Tamgur',
    description: 'Move beyond Claude Max and Codex subscriptions with stable, pay-as-you-go API access for Claude Code, Codex, GPT-5, and Gemini.',
    ogLocale: 'en_US',
  },
  fr: {
    title: 'API Claude Code et Codex à la demande | Tamgur',
    description: "Libérez-vous des abonnements Claude Max et Codex avec un accès API stable et facturé à l'usage pour Claude Code, Codex, GPT-5 et Gemini.",
    ogLocale: 'fr_FR',
  },
  ru: {
    title: 'Claude Code и Codex API с оплатой по факту | Tamgur',
    description: 'Откажитесь от подписок Claude Max и Codex: стабильный API с оплатой по факту для Claude Code, Codex, GPT-5 и Gemini.',
    ogLocale: 'ru_RU',
  },
  ja: {
    title: 'Claude Code・Codex 従量課金 API | Tamgur',
    description: 'Claude Max と Codex の月額サブスクに代わる、Claude Code、Codex、GPT-5、Gemini 向けの安定した従量課金 API。',
    ogLocale: 'ja_JP',
  },
  vi: {
    title: 'API Claude Code và Codex trả theo mức dùng | Tamgur',
    description: 'Thoát khỏi gói đăng ký Claude Max và Codex với API ổn định, trả theo mức dùng cho Claude Code, Codex, GPT-5 và Gemini.',
    ogLocale: 'vi_VN',
  },
};
