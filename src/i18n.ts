...
export const messages: Record<Locale, Messages> = {
  'zh-CN': {
    ...
    viewPricing: '查看价格',
    docs: '开发文档',
    trust: 'Email tamgurcyu@gmail.com（2026 年 7 月 31 日前联系可领取充值折扣）',
    unifiedApi: '统一 API',
  ...
  en: {
    ...
    heroMigration: 'OpenAI SDK compatible — migrate by changing the Base URL',
    ...
    docs: 'Documentation',
    trust: 'Email tamgurcyu@gmail.com (Contact us by July 31, 2026 to receive a credit top-up discount)',
  ...
  fr: {
    ...
    heroMigration: "Compatible avec le SDK OpenAI — changez simplement l'URL de base",
    heroPriceTitle: 'Coût mensuel typique',
    heroOfficialPlatform: 'Plateforme officielle',
    heroTamgurPlatform: 'Tamgur',
    start: 'Recharger et commencer',
    viewPricing: 'Voir les tarifs',
    docs: 'Documentation',
    trust: "Email tamgurcyu@gmail.com (Contactez-nous avant le 31 juillet 2026 pour bénéficier d'une remise sur votre recharge)",
  ...
  ru: {
    ...
    heroMigration: 'Совместимо с OpenAI SDK — для перехода измените Base URL',
    heroPriceTitle: 'Типичная стоимость в месяц',
    heroOfficialPlatform: 'Официальная платформа',
    heroTamgurPlatform: 'Tamgur',
    start: 'Пополнить и начать',
    viewPricing: 'Посмотреть цены',
    docs: 'Документация',
    trust: 'Email tamgurcyu@gmail.com (Свяжитесь с нами до 31 июля 2026 года, чтобы получить скидку на пополнение баланса)',
  ...
  ja: {
    ...
    heroMigration: 'OpenAI SDK 互換 — Base URL の変更だけで移行',
    ...
    viewPricing: '料金を見る',
    docs: 'ドキュメント',
    trust: 'Email tamgurcyu@gmail.com（2026年7月31日までのご連絡でチャージ割引）',
    unifiedApi: '統合 API',
  ...
  vi: {
    ...
    heroMigration: 'Tương thích OpenAI SDK — chỉ cần thay Base URL để chuyển đổi',
    heroPriceTitle: 'Chi phí hàng tháng điển hình',
    heroOfficialPlatform: 'Nền tảng chính thức',
    heroTamgurPlatform: 'Tamgur',
    start: 'Nạp tiền và bắt đầu',
    viewPricing: 'Xem giá',
    docs: 'Tài liệu',
    trust: 'Email tamgurcyu@gmail.com (Liên hệ trước ngày 31/07/2026 để nhận ưu đãi nạp tiền)',
