...
export const messages: Record<Locale, Messages> = {
  'zh-CN': {
    ...
    heroDescription: '首次注册赠送 $1 token额度',
    ...
    viewPricing: '查看价格',
    docs: '开发文档',
    trust: '合作请联系 rainkii8518231@gmail.com',
    unifiedApi: '统一 API',
  ...
  en: {
    ...
    heroDescription: 'Free $1 token quota for first-time registration',
    ...
    start: 'Access API Immediately',
    viewPricing: 'View Pricing',
    docs: 'Documentation',
    trust: 'Cooperation: rainkii8518231@gmail.com',
  ...
  fr: {
    ...
    heroDescription: 'Free token quota for first-time registration',
