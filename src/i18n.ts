...
export const messages: Record<Locale, Messages> = {
  ...
  en: {
    ...
    flexibleDescription: 'Pay precisely for consumed tokens. Credits stay available and costs remain predictable.',
  ...
  fr: {
    ...
    flexibleDescription: 'Payez uniquement les tokens consommés, avec des crédits durables et des coûts prévisibles.',
