...
export const messages: Record<Locale, Messages> = {
  'zh-CN': {
    ...
    viewPricing: '查看价格',
    docs: '开发文档',
    trust: '2026 年 7 月 31 日前联系可领取充值折扣',
    unifiedApi: '统一 API',
  ...
  en: {
    ...
    docs: 'Documentation',
    trust: 'Contact us by July 31, 2026 to receive a credit top-up discount',
  ...
  fr: {
    ...
    docs: 'Documentation',
    trust: "Contactez-nous avant le 31 juillet 2026 pour bénéficier d'une remise sur votre recharge",
  ...
  ru: {
    ...
    docs: 'Документация',
    trust: 'Свяжитесь с нами до 31 июля 2026 года, чтобы получить скидку на пополнение баланса',
  ...
  vi: {
    ...
    viewPricing: 'Xem giá',
    docs: 'Tài liệu',
    trust: 'Liên hệ trước ngày 31/07/2026 để nhận ưu đãi nạp tiền',
