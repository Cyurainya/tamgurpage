...
export const messages: Record<Locale, Messages> = {
  'zh-CN': {
    ...
    heroTitle: '为开发者打造的稳定 AI API',
    heroHighlight: '最高省 70%',
    heroModelLine: '无需月费套餐 · 只为实际用量付费',
  ...
  en: {
    ...
    heroTitle: 'Stable AI APIs for Builders',
    heroHighlight: 'Save Up to 70%',
    heroModelLine: 'No Monthly Plans · Pay Only For What You Use',
  ...
  fr: {
    ...
    heroTitle: 'Des API IA stables pour les développeurs',
    heroHighlight: "Jusqu'à -70 %",
    heroModelLine: "Aucun forfait mensuel · Payez uniquement ce que vous utilisez",
  ...
  ru: {
    ...
    heroTitle: 'Стабильные AI API для разработчиков',
    heroHighlight: 'До 70% дешевле',
    heroModelLine: 'Без ежемесячных тарифов · Платите только за использование',
  ...
  ja: {
    ...
    heroTitle: '開発者のための安定した AI API',
    heroHighlight: '最大 70% お得',
    heroModelLine: '月額プラン不要 · 使った分だけお支払い',
  ...
  vi: {
    ...
    heroTitle: 'AI API ổn định dành cho nhà phát triển',
    heroHighlight: 'Tiết kiệm đến 70%',
    heroModelLine: 'Không có gói hàng tháng · Chỉ trả cho mức sử dụng thực tế',
